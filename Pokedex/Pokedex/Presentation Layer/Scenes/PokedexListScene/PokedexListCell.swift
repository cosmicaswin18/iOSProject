...
class PokedexListCell: UICollectionViewCell {
    ...
    func configureViewComponents() {
        ...
        imageView.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 86)
